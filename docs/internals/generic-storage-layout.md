...
contiguous elements in `[0, len)`. It records field offsets and the generic
element parameter in code generation; it does not identify `Array`, `Header`,
or any library API by name.
