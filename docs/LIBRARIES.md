...
contain no legacy closure or named-function-forwarder chunks. Those artifacts
must be rebuilt from source so callers and callees agree on environment cleanup.
